...
colnames(coil)[29] <- "AP1"
colnames(coil)[30] <- "AP2"
colnames(coil)[31] <- "AP3"
colnames(coil)[32] <- "AP4"
colnames(coil)[33] <- "EX1"
colnames(coil)[34] <- "EX2"
colnames(coil)[35] <- "EX3"
colnames(coil)[36] <- "EX4"
colnames(coil)[37] <- "EX5"
variable.names(coil)
write_csv(coil, file = "coildata.csv")